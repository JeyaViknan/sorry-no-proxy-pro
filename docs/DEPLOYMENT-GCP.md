# Deployment Guide — Google Cloud Run (billed)

> **This path requires a credit card.** Google Cloud needs an active billing
> account for Cloud Run, Cloud Build, Artifact Registry and Cloud Storage.
>
> For a **free, no-card** deployment see **[DEPLOYMENT.md](DEPLOYMENT.md)**,
> which uses Hugging Face Spaces (16 GB RAM free) and Cloudflare Pages.
>
> Use this path when your institution already has Google Cloud, or when you
> need an SLA, an Indian region, and no idle-sleep behaviour.
