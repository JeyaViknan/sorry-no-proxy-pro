...
# InsightFace (ArcFace-style) embeddings are typically compared with cosine similarity.
# NOTE: `face_db.pkl` must contain embeddings generated by the SAME model family.
...
def get_face_app() -> FaceAnalysis:
    ...
    # `buffalo_l` is a good default pack (detector + recognition).
    app = FaceAnalysis(name="buffalo_l")
    # CPU execution; ctx_id=-1 means CPU in insightface.
